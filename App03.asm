;resta, funciona correctamente con el primer numero mayor al segundo ya que no da como tal numeros negativos decimales
            .model small
            .stack
            .data  
            ;mensajes a mostrar
...
mensRes     db 10, 13, "El resultado de la resta es: $"
...
resta       proc
            ...
            mov al, num1
            sub al, num2;con sub se resta el valor de num2 a al (lo que se dio en num1)
